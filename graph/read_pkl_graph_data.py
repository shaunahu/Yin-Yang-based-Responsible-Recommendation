...
if __name__ == "__main__":
    ...
    pkl_path = "./graph_data/news_item_graph_full_augmented_with_frequency.pkl" # with edge info
    ...
    print("Sample nodes:", list(graph.nodes(data=True))[:10000])
    print("Sample edges:", list(graph.edges(data=True))[:10000])
