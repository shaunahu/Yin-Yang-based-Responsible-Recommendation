...
CSV-friendly mode:
- If a node is unreachable from the chosen cluster center (would be -1),
  replace it with (max_reachable_distance_in_that_cluster + 1).
- This only affects the exported CSV, NOT training tensors / embeddings.
"""
